...
export const AboutPageContent: PageType = PageSchema.parse({
  ...
  heroSection: {
    ...
    content: [
      {
        title: "Full‑stack engineer with a data + UX mindset",
        desc:
          "I’m a Computer Science + Data Science graduate from Worcester Polytechnic Institute (B.S. CS, M.S. Data Science). I love building products end‑to‑end — from data models and APIs to polished, accessible UI. I’m always looking for opportunities to learn, iterate, and ship impactful software.",
        tags: ["React", "Python", "UX", "Databases", "Deployment"],
      },
      {
        desc:
          "I grew up with a lifelong curiosity for technology and I thrive in collaborative environments where communication, ownership, and craftsmanship matter.",
      },
    ],
  },
  ctas: [
